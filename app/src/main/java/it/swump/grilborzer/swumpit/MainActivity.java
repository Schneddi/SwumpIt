...
public class MainActivity extends AppCompatActivity {
    ...
    private DirectionClass directionClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        directionClass = new DirectionClass(this);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == PICK_FILE && resultCode == Activity.RESULT_OK && data != null) {
            ...
            try {
                ...
                inputStream.close();
                directionClass.getDirection(); //Testaufruf, bitte nachher entfernen ;)
                directionClass.compareDirection(90.0); //Testaufruf, bitte nachher entfernen ;)
